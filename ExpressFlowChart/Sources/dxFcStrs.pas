...
resourcestring
  sdxFlowChartArrowStyleNone = 'Nenhum';
  sdxFlowChartArrowStyleArrow = 'Flecha';
  sdxFlowChartArrowStyleEllipseArrow = 'Seta de elipse';
  sdxFlowChartArrowStyleRectArrow = 'Seta retangular';
  sdxFlowChartArrowStyleClosedASMEarrow = 'Seta ASME fechada';
  sdxFlowChartArrowStyleFilledASMEarrow = 'Seta ASME cheia';
  sdxFlowChartArrowStyleClosedArrow = 'Seta fechada';
  sdxFlowChartArrowStyleFilledArrow = 'Seta cheia';
  sdxFlowChartArrowStyleIndentedClosedArrow = 'Seta fechada recuada';
  sdxFlowChartArrowStyleIndentedFilledArrow = 'Seta enchido recuado';
  sdxFlowChartArrowStyleOutdentedClosedArrow = 'Seta fechado superada';
  sdxFlowChartArrowStyleOutdentedFilledArrow = 'Flecha cheia cheia';
  sdxFlowChartArrowStyleClosedDoubleArrow = 'Seta dupla fechada';
  sdxFlowChartArrowStyleFilledDoubleArrow = 'Seta dupla preenchida';
  sdxFlowChartArrowStyleDiamond = 'Diamante';
  sdxFlowChartArrowStyleFilledDiamond = 'Diamante enchido';
  sdxFlowChartArrowStyleClosedDiamond = 'Diamante fechado';
  sdxFlowChartArrowStyleFilledClosedDiamond = 'Encher o diamante fechado';
  sdxFlowChartArrowStyleDimensionLine = 'Linha de dimensão.';
  ...
  sdxFlowChartDialogButtonCancel = '&Cancelar';
