...
resourcestring
  ...
  sdxLayoutControlContainerCannotBeControl = 'O recipiente não pode ser um controle para o item.';
  sdxLayoutControlControlIsUsed = 'O %s O controle já é usado por %s item.';

  sdxLayoutControlNewGroupCaption = 'Novo grupo';
  sdxLayoutControlRoot = 'Root';
  sdxLayoutControlNewItemCaption = 'Novo item';
  ...
  sdxLayoutControlEmptyCaption = '<vazio>';
