...
resourcestring
  scxSEditRepositoryColorComboBoxItem = 'ColorComboBox|Representa uma caixa de combinação para permitir a seleção de uma cor';
  scxSEditRepositoryColorEditItem = 'ColorEdit|Representa um editor com uma Galeria de cores suspensa';
  scxSEditRepositoryFontNameComboBoxItem = 'FontNameComboBox|Representa uma caixa de combinação para permitir a seleção de uma fonte';
  scxSEditRepositoryLabelItem = 'Label|Representa um label';
  scxSEditRepositoryProgressBarItem = 'ProgressBar|Representa um controle avançado da barra de progresso';
  scxSEditRepositoryTrackBarItem = 'TrackBar|Representa um editor que fornece um controle deslizante para selecionar um valor em sua barra';
  scxSEditRepositoryRangeTrackBarItem = 'RangeTrackBar|Representa um editor que fornece dois sliders para selecionar um intervalo de valores em sua barra';
  scxSEditRepositorySpinButtonItem = 'SpinButton|Representa um botão spin';
  scxSEditRepositoryCheckComboBox = 'CheckComboBox|Representa uma caixa de combinação com uma lista de verificação suspensa';
  scxSEditRepositoryShellComboBoxItem = 'ShellComboBox|Representa uma caixa de combinação com uma visão de árvore do shell suspenso';
  scxSEditRepositoryCheckGroupItem = 'CheckGroup|Representa um editor que fornece um conjunto de caixas de seleção';
  scxSEditRepositoryRatingControlItem = 'RatingControl|Representa um controle de classificação';
  scxUDAssociated = ' já está associado com ';
  scxHotZoneStyleMediaPlayer9 = 'MediaPlayer9';
  scxHotZoneStyleMediaPlayer8 = 'MediaPlayer8';
  scxHotZoneStyleXPTaskBar = 'XPTaskBar';
  scxHotZoneStyleSimple = 'Simples';
  scxLoadingFonts = 'Carregando ...';

  cxSEditCheckGroupCaptionStateDelimiter = ': ';
  cxSEditCheckGroupFilterColumnSeparator = '; ';
  cxSEditCheckGroupChecked = 'Verificada';
  cxSEditCheckGroupGrayed = 'acinzentado';
  cxSEditCheckGroupUnchecked = 'Desmarcada';
  ...
  cxSCheckControlIncorrectItemCount = 'O número de itens não pode ser maior que 64, se o editValueformat for cvfinteger';

  cxSColorComboBoxDefaultDescription = 'Cor não selecionada';

  cxSEditRichEditLibraryError = 'Não é possível carregar o RichEdit library';
  cxSEditRichEditLineInsertionError = 'RichEdit Erro de inserção de linha.';
  cxSEditRichEditLoadFail = 'Falha ao carregar Stream';
  cxSEditRichEditSaveFail = 'Falha ao salvar Stream';
  cxSEditRichEditSelectionSaveFail = 'Falha ao savar a seleção Stream';
  cxSEditRichEditOleInterfaceFail = 'RichEdit: Falha ao obter interface iricheditolole';
  cxSEditRichEditCallBackFail = 'RichEdit: Falha ao definir o retorno de chamada';
  cxSEditRichEditLinkFail = 'RichEdit: Não é possível vincular a uma fonte inválida';
  scxSEditRepositoryRichEditItem = 'RichEdit|Representa um editor que fornece recursos de formatação de texto ricos';

  cxSEditRichEditUndoCaption                 = '&Desfazer';
  cxSEditRichEditRedoCaption                 = '&Refazer';
  cxSEditRichEditCutCaption                  = 'Cor&tar';
  cxSEditRichEditCopyCaption                 = '&Copiar';
  cxSEditRichEditPasteCaption                = 'Co&lar';
  cxSEditRichEditDeleteCaption               = '&Excluir';
  cxSEditRichEditSelectAllCaption            = 'Selecionar &Tudo';
