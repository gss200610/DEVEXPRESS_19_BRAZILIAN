...
resourcestring
  sdxOldFormat = 'A versão de dados da pele é mais antiga que a versão atual da Biblioteca do ExpressSkins.'  + #13#10 +
                 'Os skins não podem ser carregados devido a um incompatibilidade de versão.';
  sdxSkinInvalidStreamFormat = 'Formato de fluxo inválido.';
  sdxSkinElementNotFound = 'Elemento "%s" não encontrado';
  sdxSkinGroupNotFound = 'Grupo "%s" não encontrado';
  sdxSkinParentNotFound = 'Skin Mãe "%s" não encontrado';
