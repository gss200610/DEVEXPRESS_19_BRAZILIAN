...
resourcestring
  scxUntitledEvent = 'Evento sem título';
  ...
  scxPrevAppointment = 'Nomeação anterior';

  // dialogs constants
  scxDeleteRecurringEventDescription = 'é um evento recorrente. Você quer excluir apenas esta ocorrência ou a série?';
  scxEditRecurringEventDescription   = 'é um evento recorrente. Você quer abrir apenas essa ocorrência ou a série?';

  scxGoToDateDialogCaption     = 'Vá até a data';
  scxDeleteTypeDialogCaption   = 'Confirmar esclusão';
  scxDeleteTypeOccurrenceLabel = 'Exclua esta ocorrência';
  scxDeleteTypeSeriesLabel     = 'Exclua a série';
  scxEditTypeDialogCaption     = 'Abra o item recorrente';
  scxEditTypeOccurrenceLabel   = 'Abra esta ocorrência';
  scxEditTypeSeriesLabel       = 'Abra a série';
