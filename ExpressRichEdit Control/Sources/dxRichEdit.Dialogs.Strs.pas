...
resourcestring
  sdxRichEditTabForm_All = 'Tudo';


  sdxRichEditInvalidSize = 'O número deve estar entre %d e %d.';
  sdxRichEditInvalidMeasurementValue = 'A medição deve ser entre %s e %s.';
  sdxRichEditInvalidNumber = 'Este não é um número válido.';
  sdxRichEditInvalidMeasurement = 'Esta não é uma medição válida';


  sdxSectionPropertiesApplyToWholeDocument = 'Documento inteiro';
  sdxSectionPropertiesApplyToCurrentSection = 'Seção atual';
  sdxSectionPropertiesApplyToSelectedSections = 'Seções selecionadas';
  sdxSectionPropertiesApplyThisPointForward = 'Este ponto para frente';

  sdxRichEditDialogButtonOK = 'OK';
  sdxRichEditDialogButtonCancel = 'Cancelar';


  sdxRichEditParagraphDialogAfter = 'Dep&ois:';
  sdxRichEditParagraphDialogAlignment = 'Ali&nhamento:';
  sdxRichEditParagraphDialogAt = '?:';
  sdxRichEditParagraphDialogBefore = '&Antes:';
  sdxRichEditParagraphDialogButtonTabs = '&Abas...';
  sdxRichEditParagraphDialogBy = 'P&or:';
  sdxRichEditParagraphDialogDontAddSpace = 'Não adicione SPA & CE entre parágrafos do mesmo estilo';
  sdxRichEditParagraphDialogForm = 'Parágrafo';
  sdxRichEditParagraphDialogGeneral = 'Em geral';
  sdxRichEditParagraphDialogIndentation = 'Indentação';
  sdxRichEditParagraphDialogIndentsAndSpacing = '&Recuo e espaçamento';
  sdxRichEditParagraphDialogKeepLinesTogether = '&Mantenha as linhas juntas';
  sdxRichEditParagraphDialogLeft = '&Esquerda:';
  sdxRichEditParagraphDialogLineAndPageBreaks = 'Linha e &';
  sdxRichEditParagraphDialogLineSpacing = 'Li&nha espaçamento:';
  sdxRichEditParagraphDialogOutlinelevel = '&Nível de contorno:';
  sdxRichEditParagraphDialogPageBreakBefore = 'Página &quebrar antes';
  sdxRichEditParagraphDialogPagination = 'Paginação';
  sdxRichEditParagraphDialogRight = '&Direita:';
  sdxRichEditParagraphDialogSpacing = 'Espaçamento';
  sdxRichEditParagraphDialogSpecial = '&Especial:';


  sdxParagraphAlignmentLeft = 'Esquerda';
  sdxParagraphAlignmentRight = 'Direita';
  sdxParagraphAlignmentCenter = 'Centro';
  sdxParagraphAlignmentJustify = 'Justificar';

  sdxParagraphLineSpacingSingle = 'Solteira';
  sdxParagraphLineSpacingSesquialteral = '1.5 linhas';
  sdxParagraphLineSpacingDouble = 'Duplo';
  sdxParagraphLineSpacingMultiple = 'Multiplo';
  sdxParagraphLineSpacingExactly = 'Exatamento';
  sdxParagraphLineSpacingAtLeast = 'Pelo menos';

  sdxParagraphFirstLineIndentNone = '(nenhum)';
  sdxParagraphFirstLineIndentIndented = 'Primeira linha';
  sdxParagraphFirstLineIndentHanging = 'Pendurada';

  sdxParagraphOutlineLeve0 = 'Corpo do Texto';
  sdxParagraphOutlineLeve1 = 'Nível 1';
  sdxParagraphOutlineLeve2 = 'Nível 2';
  sdxParagraphOutlineLeve3 = 'Nível 3';
  sdxParagraphOutlineLeve4 = 'Nível 4';
  sdxParagraphOutlineLeve5 = 'Nível 5';
  sdxParagraphOutlineLeve6 = 'Nível 6';
  sdxParagraphOutlineLeve7 = 'Nível 7';
  sdxParagraphOutlineLeve8 = 'Nível 8';
  sdxParagraphOutlineLeve9 = 'Nível 9';


  sdxRichEditTabsDialogAlignment = 'Alinhamento';
