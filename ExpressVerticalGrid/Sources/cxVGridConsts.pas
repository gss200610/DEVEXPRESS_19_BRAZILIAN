...
resourcestring
  cxSvgIndexError = 'Erro de índice.';
  cxSvgInvalidRowClass = 'Não é possível criar linha';
  cxSvgAssignRowsError = 'Não pode atribuir linhas';
  cxSvgDeletingFocusedConfirmationText = 'Apagar registro?';
  cxSvgDeletingConfirmationCaption = 'Confirme';

  cxSvgOKCaption = 'OK';
  cxSvgCancelCaption = 'Cancelar';

  scxSvgFindPanelClearButtonCaption = 'Limpar';
  scxSvgFindPanelInfoText = 'Digite o texto para pesquisar...';
  scxSvgFindPanelFindButtonCaption = 'Achar';

  cxSvgCustomizeCaption = 'Customizar';
  cxSvgCustomizeCategoriesCaption = 'Categorias';
  cxSvgCustomizeDeleteCategory = '&Excluir';
  cxSvgCustomizeNewCategory = '&Novo...';
  cxSvgCustomizeRowsCaption = 'Linhas';

  cxSvgNewCategoryCaption = 'Nova categoria';
