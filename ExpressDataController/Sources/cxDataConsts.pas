...
resourcestring
  ...
  cxSDataWriteError = 'Erro de gravação de fluxo';
  ...
  cxSDataProviderModeError = 'Esta operação não é suportada no modo de provedor';
  cxSDataInvalidStreamFormat = 'Formato de fluxo inválido.';
...
//  cxSDBDataSetNil = 'DataSet is nil';
  ...
  cxSDBNotInGridMode = 'DataController não em GridMode';
