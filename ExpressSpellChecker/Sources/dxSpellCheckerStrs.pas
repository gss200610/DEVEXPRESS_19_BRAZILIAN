...
resourcestring
  ...
  sdxSpellCheckerMoreThanOne = 'Um aplicativo deve conter apenas um único TdxSpellChecker';
  sdxSpellCheckerFileFormatMismatch = 'Formato de arquivo incompativel';
  sdxSpellCheckerISpellDictionary = 'ISpell';
  sdxSpellCheckerOpenOfficeDictionary = 'OpenOffice';
  sdxSpellCheckerUserDictionary = 'Do utilizador';
  ...
  sdxSpellCheckerAddButton = '&Adicionar';
  sdxSpellCheckerAddButton1 = 'A&dicionar';
  sdxSpellCheckerChangeButton = '&Mudar';
  sdxSpellCheckerEditButton = 'Editar...';
  sdxSpellCheckerChangeAllButton = 'Mudar T&udo';
  sdxSpellCheckerCloseButton = 'Fechar';
  sdxSpellCheckerDeleteButton = '&Excluir';
  sdxSpellCheckerDeleteButton1 = 'Ex&cluir';
  sdxSpellCheckerDeleteButton2 = 'Exc&luir';
  sdxSpellCheckerDeleteAllButton = 'Excluir &Tudo';
  sdxSpellCheckerIgnoreButton = '&Ignorar';
  sdxSpellCheckerIgnoreAllButton = 'I&gnorar tudo';
  sdxSpellCheckerOptionsButton = '&Opções...';
  sdxSpellCheckerSuggestButton = '&Sugerir';
  sdxSpellCheckerUndoButton = '&Desfazer';
  sdxSpellCheckerUndoEditButton = '&Desfazer Editar';
  sdxSpellCheckerUndoLastButton = '&Desfazer último';
  sdxSpellCheckerChangeTo = 'Mudar &para:';
  sdxSpellCheckerRepeatedWord = 'Palavra repetida:';
  sdxSpellCheckerSuggestions = 'Sugestões:';
  sdxSpellCheckerNotInDictionary = 'Não no dicionário:';
  sdxSpellCheckerNoSuggestions = '(Nenhuma sugestão)';
