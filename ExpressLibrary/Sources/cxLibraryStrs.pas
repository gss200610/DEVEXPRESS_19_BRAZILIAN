...
resourcestring
  ...
  scxCantCreateRegistryKey = 'Não é possível criar a chave do Registro: \%s';
  scxCantOpenRegistryKey   = 'Não é possível abrir a chave do Registro: \%s';
  scxConverterCantCreateStyleRepository = 'Não é possível criar o repositório de estilo';
